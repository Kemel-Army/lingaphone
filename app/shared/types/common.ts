...
export const STUDENT_SIDEBAR: SidebarItem[] = [
  ...
  { label: 'Дневник', icon: 'i-lucide-bar-chart-3', to: '/student/grades' },
  { label: 'Мой прогресс', icon: 'i-lucide-line-chart', to: '/student/progress' },
...
export const TEACHER_SIDEBAR: SidebarItem[] = [
  ...
  { label: 'Дневник', icon: 'i-lucide-table', to: '/teacher/grades' },
  { label: 'Мотивация', icon: 'i-lucide-medal', to: '/teacher/motivation', badge: 'NEW' },
  { label: 'Проверка работ', icon: 'i-lucide-inbox', to: '/teacher/submissions' },
  { label: 'Сообщения', icon: 'i-lucide-message-circle', to: '/teacher/messenger', badge: 'NEW' },
...
export const ADMIN_SIDEBAR: SidebarItem[] = [
  ...
  { label: 'Мотивация', icon: 'i-lucide-medal', to: '/admin/motivation', badge: 'NEW' },
